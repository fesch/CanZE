    ...
    void load () {
        ...
        String fieldDef1 =
                ""
                        ...
                        +"764,16,151,1,0,0,,2181,6181,2ff,VIN Numero Identification\n" //
                        +"764,16,47,1,0,0,,2100,6100,ff,Reponse LID utilises\n" //
                        +"764,24,55,1,0,0,,220127,620127,ff,Config Generale_VehicleIdent default value\n" //
                        ...
                        +"764,16,31,1,0,0,,2182,6182,ff,Version Messagerie Mux\n" //
                        ...
                        +"764,16,103,1,0,0,,21B4,61B4,ff,RECVAL2\n" //
                        +"764,16,103,1,0,0,,21B3,61B3,ff,RECVAL1\n" //
                        ...
                        +"764,24,39,1,0,0,,222505,622505,ff,Causes allumage temoins Ref.REF Present Alerte 1\n" //
                        +"764,40,55,1,0,0,,222505,622505,ff,Causes allumage temoins Ref.REF Present Alerte 2\n" //
                        +"764,24,39,1,0,0,,222503,622503,ff,Causes allumage temoins Stop.STOP Present Alerte 1\n" //
                        +"764,40,55,1,0,0,,222503,622503,ff,Causes allumage temoins Stop.STOP Present Alerte 2\n" //
                        ...
                        +"764,24,39,1,0,0,,222501,622501,ff,Causes allumage temoins Service Present.SERVICE Present Alerte 1\n" //
                        +"764,40,55,1,0,0,,222501,622501,ff,Causes allumage temoins Service Present.SERVICE Present Alerte 2\n" //
                        ...
                        +"764,24,39,1,0,0,,222502,622502,ff,Causes allumage temoins Service Memorise.SERVICE Memorise Alerte 1\n" //
                        +"764,40,55,1,0,0,,222502,622502,ff,Causes allumage temoins Service Memorise.SERVICE Memorise Alerte 2\n" //
                        +"764,24,39,1,0,0,,222504,622504,ff,Causes allumage temoin Stop Memorise.STOP Memorise Alerte 1\n" //
                        +"764,40,55,1,0,0,,222504,622504,ff,Causes allumage temoin Stop Memorise.STOP Memorise Alerte 2\n" //
                        +"764,24,39,1,0,0,,222506,622506,ff,Causes allumage temoin Ref Memorise.REF Memorise Alerte 1\n" //
                        +"764,40,55,1,0,0,,222506,622506,ff,Causes allumage temoin Ref Memorise.REF Memorise Alerte 2\n" //
                        ...
                        +"764,16,95,1,0,0,,2184,6184,2ff,ClusterProductionNumber en ASCII\n" //
                        +"764,96,143,1,0,0,,2184,6184,2ff,ClusterProductionDate en ASCII\n" //
                        +"764,24,103,1,0,0,,22F196,62F196,2ff,Numero homologation reference\n" //
                        +"764,24,103,1,0,0,,22F18E,62F18E,2ff,Reference piece VehicleManufacturer KitAssemblyPartNumber\n" //
                        +"764,24,103,1,0,0,,22F187,62F187,2ff,Reference piece VehicleManufacturer SparePartNumber\n" //
        ...
        Frames.getInstance().load("764,0,0,CLU\n");
