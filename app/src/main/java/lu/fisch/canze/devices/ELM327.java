            ...
            if(fields.size()>0) {
                ...
                if (runFilter) {
                    ...
                    if (field.isIsoTp()) {
                        ...
                        // however, make sure proper flushing is done as we do here with the 100 mS for waitMillis
