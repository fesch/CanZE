 ...
 * @author robertfisch
 */
public class BarTest extends Drawable {

    public BarTest() {
        super();
    }

    public BarTest(int x, int y, int width, int height) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    public BarTest(DrawSurfaceInterface drawSurface, int x, int y, int width, int height) {
