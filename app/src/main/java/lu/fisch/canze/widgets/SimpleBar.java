 ...
 * @author robertfisch
 */
public class SimpleBar extends Drawable {

    public SimpleBar() {
        super();
    }

    public SimpleBar(int x, int y, int width, int height) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    public SimpleBar(DrawSurfaceInterface drawSurface, int x, int y, int width, int height) {
