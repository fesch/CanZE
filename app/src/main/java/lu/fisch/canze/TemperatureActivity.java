                ...
                for (int i = 0; i < widgets.size(); i++) {
                    ...
                    for(int s=0; s<sids.length; s++) {
                        ...
                        if (field == null) {
                            ...
                            //Toast.makeText(TemperatureActivity.this,"Field with following SID <" + sids[s] + "> not found!",Toast.LENGTH_SHORT).show();
                        ...
                        public boolean onTouch(View v, MotionEvent event) {
                            ...
                            switch (maskedAction) {
                                ...
                                case MotionEvent.ACTION_POINTER_DOWN: {
                                    Intent intent = new Intent(TemperatureActivity.this, WidgetActivity.class);
